...
**Experience Music Like Never Before** - Transform your YouTube Music interface with immersive synchronized lyrics, dynamic backgrounds, and stunning visual effects.
...
## ✨ Features
🎵 **Synced Lyrics** - Perfectly timed lyrics that glide across your screen with kinetic animations.
🎨 **Dynamic Themes** - Custom-tailored styles from glassmorphism to neon cyberpunk.
✨ **Visual Effects** - Immersive environments like rain, snow, fireflies, and cosmic nebulas.
...
## 🎭 Visual Effects
LumaLyrics offers multiple "Live Environments" to match your mood:
- ❄️ **Snow Fall**: Soft, drifting particles.
- 🌧️ **Rain**: Immersive rainy atmosphere with lightning highlights.
- ✨ **Fireflies**: Magical glowing particles dancing across the screen.
- 🌌 **Cosmic**: A deep space journey with twinkling stars.
...
| <kbd>H</kbd> / <kbd>L</kbd> | Seek -10s / +10s |
| <kbd>K</kbd> / <kbd>J</kbd> | Change Track |
